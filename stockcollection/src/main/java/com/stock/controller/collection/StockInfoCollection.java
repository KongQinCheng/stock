...
public class StockInfoCollection {
     ...
     * @throws Exception
     */
    public  boolean getBean(String[] strArray,String shareCode ) throws Exception {
...
//                stockInfoMapper.delTableByStockCode(stockInfo);
    ...
    public  void findTable( ) throws Exception {
        ...
        for (int i = 0; i < arr.length; i++) {
            ...
            List<StockInfo> stockListByShareCode = stockInfoMapper.getStockListByShareCode(stockInfo.getStockCode(),999999999);
